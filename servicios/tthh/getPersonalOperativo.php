...
try {
    ...
    inner join resources.tb_personas pe on pe.persona_id = fk_persona_id WHERE ppersonal_estado ='EN FUNCIONES' and pu.puesto_modalidad = 'OPERATIVO' order by persona_apellidos, persona_nombres";
