...
try {
    ...
    $sqlDelete = "DELETE FROM admin.tb_usuario_rol WHERE fk_usuario_id = :usuario_id";
    $database->query($sqlDelete);
    $database->bind(':usuario_id', $usuario_id);
    $database->execute();

    // Insertar los nuevos roles
    $sqlInsert = "INSERT INTO admin.tb_usuario_rol (fk_usuario_id, fk_rol_id) VALUES (:usuario_id, :rol_id)";
    ...
    jsonResponse(['msg' => 'Roles actualizados correctamente', 'id' => 1], 201);
