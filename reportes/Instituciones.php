...
if (!isset($_GET['tipo'])) {
    ...
    $database->query('SELECT * FROM instituciones ORDER BY ins_nombre');
    ...
    $database = new Database();
    $database->query('SELECT * FROM instituciones WHERE tin_id = :idTipo ORDER BY ins_nombre');
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="service">Institución</th>
